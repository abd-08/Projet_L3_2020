		...
		<div class="row">
			<form id="formText" class="form-inline" action="plagiat.php" method="post" enctype="multipart/form-data">
				...
				<div id="block2" class="col-md-6" >
                    <label class="radioContainer"><h6>Texte</h6>
                        <input type="radio" name="choix2" value="texte" onclick="mode('text_2','im2','texte','vld');" checked/>
                        <span class="circle"></span>
                    </label>

                    <label class="radioContainer"><h6>Image</h6>
                        <input type="radio" name="choix2" value="image" onclick="mode('text_2','im2','image','vld');" />
                        <span class="circle"></span>
                    </label>
